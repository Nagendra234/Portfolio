    ...
    <div className="pt-3 pb-3">
      ...
      <CardDeck>
        <Row className="d-flex justify-content-around">
          {/* Frontend */}
          <Col md={4}>
            <Card className="focus" style={{backgroundColor:"rgba(0,0,0,0.1)",height:'487.55px'}}>
              <Card.Body>
                {/* Frontend */}
                ...
                <Card.Text className="card-text d-flex justify-content-start flex-column">
                  {skills.frontend.map((skill, index) => (
                    <span className="p-2" key={index}>
                      <a className="text-light text-decoration-none" href={skill.link} target="_blank" rel="noopener noreferrer">
          ...
          <Col md={4} >
            <Card className="focus" style={{backgroundColor:"rgba(0,0,0,0.1)"}}>
              <Card.Body>
           ...
           {/* Version Control */}
            ...
            <Card className="focus" style={{backgroundColor:"rgba(0,0,0,0.1)"}}>
              <Card.Body>
                ...
                <Card.Text className="card-text d-flex justify-content-start flex-column">
                  <span className="p-2">
                    <a className="text-light text-decoration-none" href={skills.versionControl[0].link} target="_blank" rel="noopener noreferrer">
